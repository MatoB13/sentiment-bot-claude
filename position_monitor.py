"""Periodicka kontrola otvorenych pozicii (naprieč vsetkymi assetmi - NAS100/NVDA/ADA/GOLD/WTI/NIGHT)
...
def _backfill_missing_exact_data(session) -> None:
...
def check_open_trades():
    ...
    session = get_session()
    try:
        _backfill_missing_exact_data(session)
